    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="card mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          ...
          <div>
            <label className="block text-sm font-medium text-zen-700 mb-2">Heure de naissance (approx.)</label>
        ...
        {result && (
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-zen-50 rounded-xl p-5 text-center">
              <p className="text-sm text-zen-500 uppercase tracking-wide mb-1">Signe solaire</p>
            ...
            <div className="bg-beige-50 rounded-xl p-5 text-center">
              <p className="text-sm text-beige-500 uppercase tracking-wide mb-1">Signe lunaire</p>
            ...
            <div className="bg-zen-50 rounded-xl p-5 text-center">
              <p className="text-sm text-zen-500 uppercase tracking-wide mb-1">Ascendant</p>
          ...
          <div className="mt-8 bg-beige-50 rounded-xl p-6 text-center">
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-full max-w-xs bg-beige-200 rounded-full h-4">
                <div className="bg-zen-500 h-4 rounded-full transition-all duration-500" style={{ width: `${compatResult.compatibility}%` }} />
              </div>
